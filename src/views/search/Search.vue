      ...
      <div class="right">
        <div class="Sort">
          ...
          <Stack
            class="Stack"
            @click="set(0)"
            :style="{ color: this.display ? 'black' : 'red' }"
          ></Stack>
          <Rubik
            class="Rubik"
            @click="set(1)"
            :style="{ color: this.display ? 'red' : 'black' }"
          ></Rubik>
          Tìm kiếm theo
        ...
        <div class="changePage">
          <div
            v-for="(part, index) in this.pageMax"
            :key="index"
            class="Number"
            @click="changePage(index)"
            :style="{ 'background-color': this.page == index ? '#ccc' : '' }"
          >
            {{ index + 1 }}
          </div>
